...
function InquiryForm() {
    ...
    return (
      ...
      {/* 제목 */}
        ...
        <input
        type="text"
        className="w-full max-w-[600px] h-[35px] border border-[#845EC2] rounded px-2 mb-4"
        placeholder="제목을 입력하세요"
        />

      {/* 본문 에디터 (여기선 예시용 div로 처리) */}
        <div className="border border-[#845EC2] rounded w-full max-w-[600px] min-h-[250px] mb-4 p-2">
        {/* 여기에 rich text editor 라이브러리 사용 가능 */}
        <textarea
        className="border border-[#845EC2] rounded w-full max-w-[600px] min-h-[250px] mb-4 p-2"
