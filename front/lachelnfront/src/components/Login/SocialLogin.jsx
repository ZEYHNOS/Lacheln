        ...
        <div className="mt-6 text-center">
            ...
            <div className="flex justify-center gap-6 mt-4">
                ...
                <button className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-md
                    ...
                    onClick={() => window.open('http://localhost:5050/oauth2/authorization/kakao', '_blank', 'width=500,height=600')}>
                ...
                <button className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-md
                                    border-2 border-transparent hover:border-[#845EC2] transition"
                    onClick={() => window.open('http://localhost:5050/oauth2/authorization/google', '_blank', 'width=500,height=600')}>
