                ...
                <div className="mx-auto w-[1240px]">
                    <div className="flex flex-col gap-5 mt-7">
                        ...
                        <div className="text-center mt-5">
                            <input type="checkbox" id="agree" className="scale-125 accent-[#845EC2]" />
                            <label htmlFor="agree" className="ml-2 text-xl">개인정보 수집동의</label>
                            <button onClick={() => setShowModal(true)} className="ml-2 text-purple-700 underline text-sm">[내용보기]</button>
                        </div>

                        {/* 신청 버튼 */}
                        <button className="mx-auto mb-4 px-6 py-2 border-2 border-[#845EC2] rounded shadow-sm bg-[#845EC2] text-white hover:bg-[#9f7ae3]">
                            상담 신청하기
                        </button>
                    </div>
                </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white p-6 rounded-xl shadow-lg max-w-md w-full max-h-[80vh] overflow-auto">
                        ...
                        <div className="flex  justify-center items-center mb-4">
                            <input type="checkbox" id="agree" className="mr-2  accent-purple-600 w-5 h-5" />
