    ...
    `}
        ...
        `}
                ...
                <div className="mt-4 mr-12">
                    <ul className="flex justify-center w-[50%] list-none p-0 m-0 border-[1px] bg-[#98979a66]">
                    ...
                    `}
                            >
                                <Link
                                    ...
                                    className={`
                            w-full h-full flex items-center justify-center text-[20px] font-semibold
                            ${item.label === "아이디정보/보안" ? "bg-[#474646] text-[#FFFFFF]" : "text-[#615e5e]"}
                            hover:bg-[#474646] hover:text-[#FFFFFF] hover:underline
                        `}
                                >
                                    {item.label}
                                </Link>
