...
export function About() {
    return (
        <div className="min-h-screen bg-white text-black flex flex-col items-center justify-center">
            <h1 className="mt-[40px] block font-bold text-[#845EC2] text-[25px]">회사소개</h1>
            <p className="block font-semibold text-[#845EC2] text-[40px] text-right mr-[450px]">레헬른은<br></br> 이렇게<br></br>만들어졌어요</p>
            <p className="block font-semibold text-[#5EBBAB] text-[24px] text-left mr-[490px]">2025년 1월 졸업을 위해 6명의 팀원이 구성되었습니다.<br></br>
                서로 밀어주고 당기며 학습과 작업을 함께하고,<br></br>
                믿음을 쌓아가며 여러가지를 시도하는 팀 입니다.</p>
            <img src={Groupphoto} alt="Groupphoto Icon" className="w-[630px] h-[420px] mb-2" />
            <div className="w-full flex justify-center mt-10">
                <div className="w-[80%] border-t-4 border-[#845EC2]"></div>
            </div>
            <p className="block font-semibold text-[#845EC2] text-[40px] text-center mt-6">레헬른은<br></br> 이런 목표를<br></br> 가지고 있어요</p>
            <p className="block font-semibold text-[#5EBBAB] text-[24px] ml-[500px]">불투명한 결혼시장에서 가격투명화를 통하여,<br></br>
                예비부부들의 가격부담을 낮추고,<br></br>
                정확한 정보를 통한 업체를 선정하여,<br></br>
                최고의 순간을 남기시길 목표로 합니다.</p>
            <img src={Weddingcost} alt="Weddingcost Icon" className="w-[630px] h-[420px] mb-2" />
            <div className="felx felx-row items-center justify-center my-4">
                <p className="block font-semibold text-[#845EC2] text-[40px] text-right mr-[450px]">레헬른은<br></br> 이러한 의미로<br></br> 지어졌어요</p>
                <p className="block font-semibold text-[#5EBBAB] text-[24px] text-right mr-[670px]">독일어로 '미소짓다'라는 뜻의<br></br>
                    'Lacheln'에서 유래 되었습니다.<br></br>
                    웨딩 촬영중 작가님들이<br></br>
                    제일 많이 하는 말씀이기도 합니다.<br></br>
                    늘 저희 사이트를 이용하실때에는<br></br>
                    웃음만 지으시길 바라는 마음입니다.^_^
                </p>
            </div>
            <img src={Lacheln_bg} alt="Lacheln_bg Icon" className="w-[650px] h-[400px] mb-6" />
...
export function Terms() {
    return (
        <div className="min-h-screen bg-white text-black flex flex-col items-start justify-center">
            <div className="text-[33px] font-semibold mt-[120px] ml-20">서비스 이용약관</div>
...
export function Privacy() {
    return (
        <div className="min-h-screen bg-white text-black flex flex-col items-start justify-center">
            <div className="text-[33px] font-semibold mt-[120px] ml-20">개인정보처리방침</div>
