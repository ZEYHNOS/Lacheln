...
public class ProductApiController {
    ...
    public API<List<ProductResponse>> getProductList(
        ...
        Page<ProductResponse> productResponseList = productBusiness.getProductList(productSearchRecord);
        Pagination pagination = paginationConverter.createPagination(productResponseList, productSearchRecord.pageable(), productSearchRecord.orderBy());
