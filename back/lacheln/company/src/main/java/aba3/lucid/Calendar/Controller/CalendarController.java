...
public class CalendarController {
    ...
    public API<CalendarResponse> createCalendar(
        ...
        CalendarResponse response = calendarBusiness.createCalendar(request, companyId);
    ...
    public API<CalendarResponse> updateCalendar(
        ...
        CalendarResponse response = calendarBusiness.updateCalendar(calId, request,companyId);
        return API.OK();
    }
